...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[V_BRIEFING_OVERVIEW_SUPPLIER_SEARCH]
AS
SELECT     TOP (100) PERCENT dbo.briefing.id, dbo.briefing.int_ref, dbo.briefing.proj_title, dbo.briefing.pro_id, dbo.briefing.cur_id, dbo.briefing.bus_id, 
                      dbo.briefing.dialyn, dbo.sbu.name AS sbu_name, dbo.sbu.id AS sbu_id, dbo.briefing.creation_date, dbo.briefing.sta_id, dbo.briefing.str_id, 
                      dbo.briefing.briefing_no, dbo.business.name AS bus_name, dbo.briefing_country.lco_id, dbo.briefing_geo.geo_id, dbo.briefing_appl_forms.apf_id, 
                      dbo.briefing_supplier.sup_id, dbo.status.name, dbo.status.name AS sta_name, dbo.briefing_supplier.winner_yn, 
                      dbo.offer_costs.fragrance_name AS frag_names
FROM         dbo.briefing INNER JOIN
                      ...
                      dbo.briefing_supplier ON dbo.briefing.id = dbo.briefing_supplier.brf_id LEFT OUTER JOIN
                      dbo.offer ON dbo.offer.brs_id = dbo.briefing_supplier.id LEFT OUTER JOIN
                      dbo.offer_costs ON dbo.offer_costs.off_id = dbo.offer.id
      ...
      Begin Tables = 
         ...
         Begin Table = "briefing_appl_forms"
            Begin Extent = 
               ...
               Bottom = 369
               Right = 378
     ', 'SCHEMA', N'dbo', 'VIEW', N'V_BRIEFING_OVERVIEW_SUPPLIER_SEARCH', NULL, NULL
GO
...
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'V_BRIEFING_OVERVIEW_SUPPLIER_SEARCH', NULL, NULL
GO
